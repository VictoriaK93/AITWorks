...
//- найти индекс элемента в массиве обьектов, отсортированных с помощью Comparator
    ...
    void testComparator(){
        ...
        int index = Arrays.binarySearch(cities,findCity);
...
// - скопировать часть массива в новый массив
    ...
    void testCopyOfRange() {
        ...
        City[] citiesCopyRange = Arrays.copyOfRange(cities, 2, cities.length - 1);
...
//- увеличить размер массива, отсортировать новый массив, найти в нем индекс, куда встанет добавляемый элемент
    ...
    void testArrayCopy() {
        ...
        System.out.println("----------------------------");
        City newCity = new City("Yalta", 0,null,0);
    ...
    void testKeepSorted() {
        ...
        City[] citiesCopy = Arrays.copyOf(cities, cities.length +1);// создаем копию массива
    ...
    // -найти индекс элемента в массиве Comparable обьектов
    @Test
    void  testComparable(){
