...
public class GarageTests {
    ...
    public static void main(String[] args) {
        ...
        Car car1 = new Car("ABC123", "Red", 2020);
        Car car2 = new Car("DEF456", "Blue", 2022);
        Car car3 = new Car("GHI789", "Green", 2018);
        ...
        System.out.println("Adding another car: " + garage.addCar(new Car("JKL012", "Black", 2023))); // Output: Adding another car: Garage is full!
